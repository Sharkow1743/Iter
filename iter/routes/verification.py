...
from iter.types.responses import VerificateResponse, GetVerificationStatusResponse
...
def get_verification_status(token: str) -> GetVerificationStatusResponse:
    return fetch(token, 'get', 'verification/status', response_schema=GetVerificationStatusResponse)